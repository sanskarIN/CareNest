...
- [`architecture/ARCHITECTURE.md`](architecture/ARCHITECTURE.md) — system overview/layering.
...
- [`architecture/DATABASE_SCHEMA.md`](architecture/DATABASE_SCHEMA.md) — SQLite relationships and schema versions.
...
- [`privacy/DATA_LIFECYCLE.md`](privacy/DATA_LIFECYCLE.md) — concise lifecycle summary.
...
- [`design/DESIGN_SYSTEM.md`](design/DESIGN_SYSTEM.md) — design tokens/visual rules.
- [`design/ACCESSIBILITY.md`](design/ACCESSIBILITY.md) — accessibility specification and manual checks.
- [`design/LOCALIZATION.md`](design/LOCALIZATION.md) — localization readiness.
- [`design/STORE_ASSETS.md`](design/STORE_ASSETS.md) — store asset guidance.
...
- [`releases/PHASE8_VERIFICATION_EVIDENCE.md`](releases/PHASE8_VERIFICATION_EVIDENCE.md) — current hardening verification evidence.
...
- [`releases/STORE_SUBMISSION_CHECKLIST.md`](releases/STORE_SUBMISSION_CHECKLIST.md) — store/package/privacy/signing preparation.
...
- [`releases/VERIFICATION_BRANCH_PROTOCOL.md`](releases/VERIFICATION_BRANCH_PROTOCOL.md) — exact-source marker-only PR protocol.
