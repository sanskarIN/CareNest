...
4. `docs/releases/STORE_POLICY_REVIEW_20260818.md` for the latest dated pre-submission store-policy review; the official live store policies remain authoritative at actual submission time.
5. `docs/COMPLETE_PROJECT_DOCUMENTATION.md` for the current end-to-end product/engineering reference.
6. specialized architecture/security/testing/setup documents for implementation details.
7. `GUMROAD.md` and `docs/marketing/GUMROAD_PLACEMENT_AND_COMPLIANCE.md` for the current external storefront placement/package boundary.
8. `what_changed.md` and `docs/history/` for chronological and historical context.
...
- `docs/releases/RELEASE_EVIDENCE.md` — required automated/manual/security/store/signing evidence contract.
...
- `docs/releases/STORE_POLICY_REVIEW_20260818.md` — dated pre-submission Apple/Google/Microsoft store-policy review and final-submission recheck requirements.
...
## 7. Current store-policy evidence

Pre-submission review date:
...
It is evidence of a dated policy review, **not** store approval and **not** a substitute for reviewing the official policies and live store-console forms against the exact production package/listing on the actual submission date.
...
## 8. Gumroad storefront documentation ownership
