...
public static class ProfileRules
{
    public static void Validate(PersonProfile profile)
    {
        ...
        {
            throw new ArgumentException("Date of birth cannot be in the future.", nameof(profile));
        }

        if (profile.BloodGroup?.Length > 20)
        {
            throw new ArgumentOutOfRangeException(nameof(profile), "Blood group text cannot exceed 20 characters.");
        }
    }
}
